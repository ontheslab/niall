...
Around 1993, I was ported NIALL into an online version to run as a door on a DOS-based BBS. The original source (.bas file) are not lost, I just can't locate them at the moment. The compiled binary survive.
